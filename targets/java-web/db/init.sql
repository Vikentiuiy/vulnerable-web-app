...
CREATE TABLE IF NOT EXISTS users (
    ...
    -- VULN:VULN-19:CWE-256:config passwords stored as unsalted MD5 (see WeakHash.md5)
    password    VARCHAR(64) NOT NULL,
    -- VULN:VULN-20:CWE-312:config secret answer kept in cleartext
...
-- VULN:VULN-21:CWE-732:config application DB user granted full privileges on everything
